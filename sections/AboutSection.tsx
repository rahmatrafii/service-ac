...
const AboutSection = () => {
  return (
    <section
      ...
      id="tentang"
    >
      <div className="h-full max-w-[1100px] flex justify-center items-center flex-col lg:flex-row bg-white gap-x-10">
        <div className=" lg:w-[50%] w-full flex items-start justify-center flex-col lg:mb-[0px] mb-[70px]">
          ...
          <p className="text-[16px] md:text-[18px]  text-slate-700  mb-[20px] md:mb-[30px] ">
            ...
            service elektronik di Batam dan sekitarnya. Dengan didukung oleh
            para tenaga kerja/Teknisi yg berpengalaman puluhan tahun di
            bidangnya, sehingga bisa menghasilkan sebuah akhir pekerjaan yang
            rapih dan berkualitas. Layanan kami ada jaminan bergaransi dalam
            jasa service yang sudah ditentukan, lama jangka waktu garansi bisa
            disesuaikan dengan apa yg telah dikerjakan. Harga jasa relatif murah
            dan harga bisa negotiable sebelum pekerjaan dimulai, ada paket harga
            yang menarik dari kami dalam service maupun intalasi/pemasangan baru
            or second.
          </p>
          <a
